...
export const projects: Project[] = [
  {
    ...
    heroAlt: "Hero banner for the McDonald's Monopoly Double Play promotion, featuring the Monopoly mascot holding fries and a smartphone against a bold yellow and white game board backdrop.",
    overviewImage: "/images/CAMON_Overview.png",
    overviewAlt: "Three iPhone mockups displaying different iterations of the McDonald's Monopoly Double Play home screen, illustrating personalized greetings and the core \"Add Code / Claim Prize\" interaction model across markets.",
    role: "UX Lead",
    ...
    sections: [
      ...
      },
      {
        ...
        imageAlt: "A side-by-side comparison of design components with a transparent Sketch logo overlay on the left with improved components and wireframes for the McDonald's Monopoly Double Play app with a transparent Figma logo overlay on the right.",
      },
      {
        label: "Solution",
        ...
        videoAlt: "A video walkthrough of the final McDonald's Monopoly Double Play app experience, demonstrating the prize claim flow.",
      },
      {
        label: "Impact",
  ...
  },
  {
    ...
    heroAlt: "Hero banner for the McDonald's Despicable Me 4 Happy Meal promotion, featuring two Minion characters holding Happy Meal boxes against a blue grid background with yellow caution tape borders.",
    overviewVideo: "/videos/DM4_Overview.mp4",
    overviewAlt: "A video overview of the Despicable Me 4 Happy Meal digital game experience, showcasing the gameplay mechanics, level progression, and screen transitions in the completed product.",
    role: "UX Lead",
    ...
    sections: [
      ...
      },
      {
        ...
        imageAlt: "Work-in-progress wireframe spread for the Despicable Me 4 Happy Meal digital game, capturing open questions and design notes across key screens including instructions, level start, gameplay, and end state.",
      },
      {
        label: "Solution",
        ...
        imageAlt: "Happy path flow diagram for the Despicable Me 4 digital game experience, mapping every screen from landing and mission code entry through gameplay levels to the end screen across easy, medium, and hard paths.",
      },
      {
        label: "Impact",
  ...
  },
  {
    ...
    heroAlt: "Hero banner for the McDonald's WcDonald's anime promotion, featuring the inverted \"W\" logo with Japanese katakana text surrounded by a cast of original anime characters dressed in WcDonald's uniforms against a bold golden energy burst background.",
    overviewImage: "/images/WcD_Overview.png",
    overviewAlt: "Two Android device mockups displaying the WcDonald's experience wireframes in a styled product render, showing the homepage with synopsis overview and how-to-participate sections alongside the weekly content navigation and character line-up layout.",
    role: "UX Lead",
    ...
    sections: [
      ...
      },
      {
        ...
        imageAlt: "Four-column wireframe spread showing the iterative design process for the WcDonald's digital hub, progressing from two early home page variations through the live mobile layout to the final desktop layout with detailed annotations for each component.",
      ...
      },
      {
        ...
        imageAlt: "Multi-device composite of the final WcDonald's digital experience, showing the fully branded anime-style UI across desktop, three mobile screens, and a landscape phone view, including the character roster, manga chapters, anime shorts, and weekly content tabs.",
  ...
  },
  {
    ...
    heroAlt: "Hero banner for the McDonald's My Rewards Frequent Fryer Program, featuring the winged rewards logo and a silhouetted airplane tracing a dotted path across a warm red-to-orange gradient.",
    overviewImage: "/images/FFP_Overview.png",
    overviewAlt: "Three iPhone mockups showing the Frequent Fryer Program in use, highlighting the home screen, skill-testing question, and Frycon code entry screens with the branded purple-to-red color system.",
    role: "UX Lead",
    client: "McDonald's Canada",
    agency: "TMS (a HAVI Co.)",
    ...
    sections: [
      ...
      },
      {
        ...
        imageAlt: "A wireframe flow diagram for the McDonald's Frequent Fryer Program, showing a snippet of the complete user journey from home page through skill-testing question, OCR code scanning, prize confirmation, and code history.",
      },
      {
        label: "Solution",
        ...
        imageAlt: "Side-by-side comparison of greyscale wireframes and final UI for the Frequent Fryer \"My Code Collection\" feature, demonstrating the passport-themed progression system with badge milestones and a surprise reveal moment.",
      },
      {
        label: "Impact",
  ...
  },
  {
    ...
    heroAlt: "Hero banner for the HMPU UX Design Library, displaying the title over a deep indigo background with faint library component screens visible in the background.",
    overviewImage: "/images/HMPUDL_Overview.png",
    overviewAlt: "Before-and-after comparison showing the evolution of the HMPU Design Library, contrasting the earlier unstructured component layout with the restructured, fully annotated Figma screen and annotation component system.",
    role: "Sr. UX Designer",
    ...
    sections: [
      ...
      },
      {
        ...
        imageBeforeAlt: "Organizational structure diagram for the HMPU Design Library, illustrating the three-tier hierarchy of Design Library, Starter Files, and Program Files with branching relationships between templates and reskin projects.",
        image: "/images/HMPUDL_Design_Process_02.png",
        imageAlt: "Documentation slide explaining the Design Library's annotation system, detailing the component hierarchy of frames, screen components, and annotation types using color-coded status indicators (black, red, and blue).",
      ...
      },
      {
        ...
        imageAlt: "Figma workspace screenshot showing the full suite of HMPU Starter Files alongside an open program file example, displaying the organized page structure and layered annotation system used across all game mechanic templates.",
  ...
  },
  {
    ...
    heroAlt: "Hero banner for the McDonald's Inside Out 2 Happy Meal promotion, featuring all nine emotion characters plus the two guards from the Disney-Pixar film arranged in rounded icon frames around the film's title treatment.",
    overviewImage: "/images/IO2_Overview.png",
    overviewAlt: "Flow diagram for the Inside Out 2 pinball game, pairing a user testing quote about confusion with the resulting wireframe solution showing a three-part interactive tutorial that addressed the onboarding gap.",
    role: "UX Lead",
    ...
    sections: [
      ...
      },
      {
        ...
        imageAlt: "Happy Path screen diagram flow for the Inside Out 2 Happy Meal digital experience, mapping the primary sequence from QR code scan through disclaimer, introductory video, toy onboarding, character selection, interactive tutorial, gameplay, and end score screen.",
  ...
  },
  {
    ...
    heroAlt: "Hero banner for the First Student website redesign project, featuring the First Student logo in white centered over a deep navy background overlaid on a blurred design system reference sheet showing typography, color swatches, icons, and accessibility guidelines.",
    overviewImage: "/images/FIRST_Overview.png",
    overviewAlt: "Before-and-after homepage comparison for the First Student website rebrand, showing the previous version with a dark video hero and blue CTA button alongside the redesigned version featuring a bright hero image of a smiling student, bold navy headline, red CTA button, and updated stats section.",
    ...
    sections: [
      ...
      },
      {
        ...
        imageAlt: "Competitive analysis spread comparing the First Student and Zum websites side by side, with annotated pros, areas of improvement, and recommended additions for each, evaluating CTA clarity, visual hierarchy, copywriting tone, and storytelling effectiveness.",
      },
      {
        label: "Design Process",
        ...
        imageAlt: "Example sitemap for firststudentinc.com, mapping the full website architecture across six primary navigation sections: Services, Innovation, Safety, Commitment, Resources, and Contact, with color-coded nodes indicating new pages, existing templates, and page collection functionality across all sub-levels.",
      },
      {
        label: "Solution",
  ...
  },
  {
    ...
    overviewAlt: "Side-by-side example of the Naturally Fresh website displayed at desktop and mobile breakpoints, showing the homepage hero with a cat being pet in a garden, promotional announcement banner, top navigation, and product lineup section featuring six product variants.",
    role: "UX & UI Designer",
    ...
    sections: [
      ...
      },
      {
        ...
        imageAlt: "Digital strategy and content planning diagram for Naturally Fresh cat litter, mapping a multi-channel campaign across five workstreams, homepage updates, product pages, blog pages, \"Where to Buy\" page, and email campaigns, with color-coded sticky notes detailing SEO keyword opportunities, retailer-specific CTAs, odor control messaging updates, and promotional timelines for retailer deals.",
      },
      {
        label: "Solution",
