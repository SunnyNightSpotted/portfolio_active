...
export const quickTakeBySlug: Record<string, QuickTake> = {
  ...
  "hmpu-design-library": {
    ...
    problem: "50+ shipped programs on the same platform, and the UX team rebuilt identical screens every time.",
  ...
  "first-student": {
    role: "UX/UI Designer, UX Researcher - site audit, component library, competitive analysis, mockups, brand portal",
    problem: "Compounding design debt, no component library, and a creative direction that changed twice before launch.",
    keyMove: "Built a component library from centralized style tokens. When brand colors changed twice, the system updated in hours, not weeks.",
    outcome: "Rebranded site live at firststudentinc.com. Design system absorbed two CMO transitions within a single project.",
  },
  "naturally-fresh": {
    role: "UX/UI Designer - site assessment, wireframes, email campaigns, SEO, developer handoff",
    problem: "The site spoke to eco-conscious buyers, but millennial cat dads were the actual purchasers. Odor control was the top driver. The site didn't mention it.",
    keyMove: "Translated a Creative Director's \"Live Odorless\" concept into digital across 7 pages and 2 email campaigns for a dev team I never met.",
    outcome: "Full UI and messaging pivot in a 3-week sprint. No functional changes to the existing site.",
  },
};
