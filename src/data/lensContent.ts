...
export const lensContentBySlug: Record<string, LensContent> = {
  ...
  "frequent-fryer-program": {
    default: "A five-week Canada-wide scavenger hunt combining a scanning tech pilot, 150,000 instant-win prizes, and a passport-style progression system tied to a new menu item launch.",
