          ...
          <div>
            ...
            <div className="space-y-4">
              <a
                ...
                className="flex items-center gap-3 text-body hover:text-foreground transition-colors focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 rounded-sm"
              >
